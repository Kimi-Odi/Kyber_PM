...
// =============================================================================
// tb_polymul_multi.v -- 5 組獨立 polynomial multiplication 測試
// -----------------------------------------------------------------------------
// 5 個獨立 polymul_top instance,各自載不同 (a, b) testvector,
// 同時跑,各自 dump BRAM_A 跟 schoolbook 結果比對。
//
// 驗證:
//   (1) DUT 對不同 input 都算對
//   (2) 設計沒有 cross-instance state pollution
// =============================================================================
module tb_polymul_multi;
    ...
    initial begin
        ...
        dbg_addr = 0; dbg_sel = 2'd0;     // 都讀 BRAM_A
