...
HD_PWD='C:/Users/user/Desktop/Kyber_PM/KYBER_PM_BD/KYBER_PM_BD.runs/design_1_polymul_axi_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_polymul_axi_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_polymul_axi_top_0_0.tcl
