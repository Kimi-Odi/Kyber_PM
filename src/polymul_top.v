...
module polymul_top #(
    ...
    // Debug / read-out port (testbench 用)
    ...
    always @(*) begin
        ...
        // === IDLE / DONE: dbg port 從外部讀任意 BRAM ===
        else begin
            case (dbg_bram_sel)
                2'd0: begin A_ena=1; A_addra=dbg_addr; end
                2'd1: begin B_ena=1; B_addra=dbg_addr; end
                2'd2: begin C_ena=1; C_addra=dbg_addr; end
            endcase
        end
    end
